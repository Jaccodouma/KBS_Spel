...
// 	// background
// 	if (drawBackGround) {
// 		tft->fillRoundRect(x, y, w, h, BUTTON_ROUNDING, gameColour->getBackgroundColour());
// 	}
// 	
...
// 		if (*this->buttonValue > SLIDER_SPEED) {
// 			*this->buttonValue= *this->buttonValue-SLIDER_SPEED;
// 		} else {
// 			*this->buttonValue = 0;
// 		}
// 		inputChanged = true;
...
// 		if (*this->buttonValue < 255-SLIDER_SPEED) {
// 			*this->buttonValue= *this->buttonValue+SLIDER_SPEED;
// 		} else {
